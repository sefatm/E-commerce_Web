...
export class DashboardComponent implements OnInit {
  ...
  private readonly ORDER_API  = 'http://localhost:8080/order';
  private readonly REPORT_API = 'http://localhost:8080/report';
  private readonly COMMISSION_API = 'http://localhost:8080/commission';
  private readonly SETTINGS_API = 'http://localhost:8080/settings';
